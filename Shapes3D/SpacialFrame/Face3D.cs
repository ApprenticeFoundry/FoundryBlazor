...
public class Face3D
{
    ...
    public double Width => Vertices.Max(v => v.X) - Vertices.Min(v => v.X);
    public double Height => Vertices.Max(v => v.Y) - Vertices.Min(v => v.Y);
    public double Depth => Vertices.Max(v => v.Z) - Vertices.Min(v => v.Z);

    public Mesh3D FaceMesh(string color, double Opacity)
    {
